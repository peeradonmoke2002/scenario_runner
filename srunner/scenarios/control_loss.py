...
class ControlLoss(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        """
        root = py_trees.composites.Parallel("ControlLoss", policy=py_trees.common.ParallelPolicy.SuccessOnOne())
        sequence = py_trees.composites.Sequence("sequence", memory=True)
        ...
        noise_behavior_1 = py_trees.composites.Parallel("Add Noise 1", policy=py_trees.common.ParallelPolicy.SuccessOnOne())
        if self.route_mode:
        ...
        noise_behavior_2 = py_trees.composites.Parallel("Add Noise 2", policy=py_trees.common.ParallelPolicy.SuccessOnOne())
        if self.route_mode:
        ...
        noise_behavior_3 = py_trees.composites.Parallel("Add Noise 3", policy=py_trees.common.ParallelPolicy.SuccessOnOne())
        if self.route_mode:
