...
class OtherLeadingVehicle(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        leading_actor_sequence_behavior = py_trees.composites.Sequence("Decelerating actor sequence behavior", memory=True)
        ...
        # Build behavior tree
        sequence = py_trees.composites.Sequence("Scenario behavior", memory=True)
        parallel_root = py_trees.composites.Parallel(policy=py_trees.common.ParallelPolicy.SuccessOnOne(), name="VehicleDeceleratingInMultiLaneSetUpRoot")
