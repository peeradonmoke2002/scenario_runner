...
class SignalizedJunctionRightTurn(JunctionRightTurn):
    ...
    def _create_behavior(self):
        ...
        sequence = py_trees.composites.Sequence("JunctionRightTurn")
        if self.route_mode:
        ...
        root = py_trees.composites.Parallel(policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE, name="SignalizedJunctionRightTurn_Root")
...
class NonSignalizedJunctionRightTurn(JunctionRightTurn):
    ...
    def _create_behavior(self):
        ...
        root = py_trees.composites.Parallel(policy=py_trees.common.ParallelPolicy.SUCCESS_ON_ONE, name = "JunctionRightTurnRoot")
        end_condition = py_trees.composites.Sequence("end_condition")
        end_condition.add_child(WaitEndIntersection(self.ego_vehicles[0]))
        end_condition.add_child(DriveDistance(self.ego_vehicles[0], self._end_distance))
        root.add_child(end_condition)
