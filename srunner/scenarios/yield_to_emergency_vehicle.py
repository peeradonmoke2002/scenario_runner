...
class YieldToEmergencyVehicle(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        - ReAddRoadLane
        """
        sequence = py_trees.composites.Sequence("YieldToEmergencyVehicle", memory=True)
        ...
        end_condition_1 = py_trees.composites.Sequence("end_condition_1", memory=True)
        ...
        end_condition_2 = py_trees.composites.Sequence("end_condition_2", memory=True)
